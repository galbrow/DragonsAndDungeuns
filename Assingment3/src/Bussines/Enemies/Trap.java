...
public class Trap extends Enemy {
    ...
    public Trap(char character, Position pos, String name, Bussines.Health hp, int attackPoints, int defenePoints, int visibletime, int invisibletime, int exp, MessageHandler cmd) {
